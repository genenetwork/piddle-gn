...
__version_min_number__ = 13  # should match "13"
__version__ = "%s.%s" % ( __version_maj_number__,  __version_min_number__) # c.f. "1.0.13"
...
class Font:
    ...
    def __init__(self, size=12, bold=0, italic=0, underline=0, face=None,ttf=None):
...
class Canvas:
	...
	def drawRect(self, x1,y1, x2,y2, edgeColor=None, edgeWidth=None, fillColor=None, clipX = [], clipY = []):
		"Draw the rectangle between x1,y1, and x2,y2. \
		These should have x1<x2 and y1<y2."
		
		pointList = [ (x1,y1), (x2,y1), (x2,y2), (x1,y2) ]
		self.drawPolygon(pointList, edgeColor, edgeWidth, fillColor, closed=1, clipX = [], clipY = [])
